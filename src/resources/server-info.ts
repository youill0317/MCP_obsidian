                ...
                contents: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            llmSafetyRules: [
                                ...
                                "Each tool call must be exactly one valid JSON object.",
                                "Do not concatenate JSON objects or add trailing text after JSON.",
                                "If JSON parsing fails, retry with only the JSON object body.",
